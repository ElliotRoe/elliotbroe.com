...
export const FirebaseIcon = React.forwardRef<SVGSVGElement, IconProps>(
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <g>
            ...
            <g>
              {" "}
              <use fill="#000000" fill-rule="evenodd" xlinkHref="#path-1">
                {" "}
              </use>{" "}
              <use
                fill="#000000"
            ...
            <g>
              {" "}
              <use fill="#000000" fill-rule="evenodd" xlinkHref="#path-3">
                {" "}
              </use>{" "}
              <use
                fill="#000000"
...
FirebaseIcon.displayName = "ArchiveIcon";
